...
const zh = {
  nav: { home: "首页", bands: "乐队", forum: "社区", favorites: "我的收藏" },
  back: "返回",
...
const en = {
  nav: { home: "Home", bands: "Bands", forum: "Forum", favorites: "Favorites" },
  back: "Back",
...
const ja = {
  nav: { home: "ホーム", bands: "バンド", forum: "コミュニティ", favorites: "お気に入り" },
  back: "戻る",
